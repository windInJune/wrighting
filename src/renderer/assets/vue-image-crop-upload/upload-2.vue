	...
	<div class="vicp-wrap">
		...
		<div class="vicp-step1" v-show="step == 1">
			...
			<div class="vicp-operate">
				<span class="vicp-cannal-btn el-button el-button--default el-button--small"  @click="off" @mousedown="ripple">{{ lang.btn.off }}</span>
			</div>
		</div>
		...
		<div class="vicp-step2" v-if="step == 2">
			<div class="vicp-crop">
				<div class="vicp-crop-left" v-show="true">
					...
					<div class="vicp-img-container" :class="[borderadius?'borderradius':'']">
						<img :src="sourceImgUrl" :style="sourceImgStyle" class="vicp-img" draggable="false"
							...
							@mouseout="createImg"
							ref="img">
						<div class="vicp-img-shade vicp-img-shade-1" v-show="false" :style="sourceImgShadeStyle"></div>
						<div class="vicp-img-shade vicp-img-shade-2" v-show="false" :style="sourceImgShadeStyle"></div>
					</div>
			...
			<div class="vicp-operate">
				<span class="vicp-success-btn el-button el-button--default el-button--small" @click="setStep(1)" @mousedown="ripple">{{ lang.btn.back }}</span>
				<span class="vicp-cannal-btn el-button el-button--primary el-button--small" @click="prepareUpload" @mousedown="ripple">{{ lang.btn.save }}</span>
			</div>
		</div>
		...
		<div class="vicp-step3" v-if="step == 3">
			...
			<div class="vicp-operate">
				<span class="vicp-cannal-btn el-button el-button--default el-button--small" @click="setStep(2)" @mousedown="ripple">{{ lang.btn.back }}</span>
				<span class="vicp-cannal-btn el-button el-button--default el-button--small" @click="off" @mousedown="ripple">{{ lang.btn.close }}</span>
			</div>
		</div>
  ...
  .vue-image-crop-upload .vicp-wrap {
    ...
    .vue-image-crop-upload .vicp-wrap .vicp-step3 .vicp-upload {
      ...
      .vue-image-crop-upload .vicp-wrap .vicp-step3 .vicp-upload .vicp-success {
        height: 100px;
		line-height: 100px; }
		.vicp-success-btn,.vicp-cannal-btn{
