<template>
    <div class="container" v-show="flag">
        ...
        <div class="inviting-box" id="drag" >
            ...
            <div class="inviting-top" id="move" v-drag>修改手机号</div>
            <div class="input-box phone">{{formData.oldPhone}}</div>
            <div class="input-box password"><input type="password" class="inputDiy"  placeholder="请输入密码" v-model.trim="formData.password" ></div>
            <div class="input-box newPhone"><input type="text" class="inputDiy" placeholder="请输入手机号" v-model.trim="formData.newPhone" ></div>
        ...
        drag(el){
            el.onmousedown = function(e){
                ...
                document.onmousemove = function(e){
                    ...
                    top>=(oBox.offsetHeight - oDrag.offsetHeight +215) && (top = oBox.offsetHeight - oDrag.offsetHeight +215);
