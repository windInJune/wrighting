<template>
    <div class="container" >
        <div class="mask" id="mask" v-show="flag"></div>
        <div class="inviting-box" id="drag" >
            ...
            <div class="input-box password"><input type="password" class="inputDiy"  placeholder="请再次输入密码" v-model.trim="formData.agpassword" ></div>
